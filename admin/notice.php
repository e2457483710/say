...
<head>
  ...
  <title>发布公告- <?php echo SITENAME?></title><meta name="renderer" content="webkit">
...
<div id="content">
  ...
  <fieldset>
    <legend>发布公告- <?php echo SITENAME?></legend>
    <textarea type="text" name="text" class="" rows="5" minlength="20" placeholder="请输入公告信息(最少20个汉字，最多150个汉字)" maxlength="150"id="doc-ta-1"></textarea><br />
	<input name="notice" class="am-btn  am-btn-secondary" type="submit"/>
  </fieldset>
</form>
</div>
<!--[if (gte IE 9)|!(IE)]><!-->
...
<?php
 ...
 if(@$_POST['notice']){
	...
	if(!$link){
		...
		//echo "成功！";
		mysqli_select_db($link,MYSQLBASE);
		$sql="INSERT INTO `notice`(`content`,`condate`) VALUES ('".$_POST['text']."','".date("Y-m-d")."')";
